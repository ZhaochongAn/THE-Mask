# dataset settings
single_frame = True
train_dataset_type = 'VSPWDataset2'
test_dataset_type = 'VSPWDataset_multiFrameTest'
valandtest_size=32
train_dilation = [-9,-6,-3]
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect', keys=['img'], 
                meta_keys=('filename', 'ori_filename', 'ori_shape', 'img_shape', 'pad_shape', 'scale_factor', 'flip', 'flip_direction', 'img_norm_cfg', 'all_names') #add all_names
            ),
        ])
]
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            dilation=train_dilation)),
    val=dict(
        type=test_dataset_type,
        test_size=valandtest_size,
        data_root=data_root,
